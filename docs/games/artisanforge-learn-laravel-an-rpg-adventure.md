---
title: "ArtisanForge: Learn Laravel an RPG adventure"
tags: [browser, free]
description: "I built ArtisanForge, a free platform to learn PHP and Laravel through a medieval-fantasy RPG. Instead of traditional tutorials, you progress through kingdoms, solve coding exercises in a browser editor, earn XP, join guilds, and fight boss battles."
...
| | |
|---|---|
| **Author** | [grazulex](https://news.ycombinator.com/user?id=grazulex) |
| **Play** | [artisanforge.online](https://artisanforge.online/) |
| **HN Thread** | [Show HN: ArtisanForge: Learn Laravel an RPG adventure](https://news.ycombinator.com/item?id=46932044) |
| **HN Points** | 25 |
